...
const CERTIFICATE_TYPE_DEPARTMENTS = Object.keys(CERTIFICATE_CONFIG).reduce((acc, type) => {
  acc[type] = [CERTIFICATE_CONFIG[type].department];
  return acc;
}, {});

module.exports = { CERTIFICATE_CONFIG, CERTIFICATE_TYPE_DEPARTMENTS };
